...
function inclusive_upgrade_notice() {
	...
	$message = sprintf( esc_html__( 'Inclusive requires at least WordPress version 5.4 and PHP version 7.2. You are running WordPress version %1$s and PHP version %2$s. Please upgrade and try again.', 'inclusive' ), $GLOBALS['wp_version'], PHP_VERSION );
...
function inclusive_customize() {
	wp_die(
		sprintf(
			/* translators: %1$s: WordPress version. %2$s PHP version.*/
			esc_html__( 'Inclusive requires at least WordPress version 5.4 and PHP version 7.2. You are running WordPress version %1$s and PHP version %2$s. Please upgrade and try again.', 'inclusive' ),
